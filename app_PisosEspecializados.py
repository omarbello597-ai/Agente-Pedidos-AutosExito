...
if archivos:
    ...
    ax.set_xlim(df_group['rotacion'].quantile(0.02), df_group['rotacion'].quantile(0.98))
    ax.set_ylim(df_group['valor'].quantile(0.02), df_group['valor'].quantile(0.98))
