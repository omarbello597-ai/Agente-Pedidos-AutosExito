...
st.title("📦 Agente de Pedidos Inteligente")
...
# Detectar columnas de ventas automáticamente
...
# 11. EXPORTAR
# =========================================
df.to_excel("pedido_sugerido.xlsx", index=False)

files.download("pedido_sugerido.xlsx")